...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  mounted: function mounted() {
	    ...
	    this.onClickOutside = function (event) {
	      if (_this2.$el !== null && !_this2.$el.contains(event.target)) {
	        _this2.close();
	      }
	    };
