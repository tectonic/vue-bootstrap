...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    ...
	    staticClass: "hours"
	  }, [_s(pad(date.getHours()))]), " ", _m(1), " ", _h('td', {
	    staticClass: "minutes"
	  }, [_s(pad(date.getMinutes()))])]), " ", _h('tr', [_h('td', {
	    staticClass: "set-clock",
	    on: {
	      "click": function($event) {
